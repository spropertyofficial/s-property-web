...
export default function AddPropertyPage() {
  ...
  // --- PERUBAHAN 1: Update Initial State ---
  ...
  // --- PERUBAHAN 2: State untuk menampung pilihan kategori ---
  ...
  // --- PERUBAHAN 3: Fetch data kategori saat komponen dimuat ---
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire("Berhasil!", "Properti baru berhasil ditambahkan", "success", {
        timer: 1500,
        showConfirmButton: false,
      }).then(() => {
        router.push("/admin/properties"); // Arahkan ke halaman daftar baru
      });
    } catch (err) {
